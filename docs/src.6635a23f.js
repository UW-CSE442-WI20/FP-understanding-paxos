...
function scroll() {
  ...
  var ypos = window.pageYOffset - screenHeight / 3;
  var section = d3.bisect(sections, ypos);
...
function update() {
  ...
  d3.selectAll('.step').style('color', function (d, i) {
    return i + 1 === curSection ? 'black' : 'lightgray';
  });
  sectionFunctions[curSection]();
}

var circleInDuration = 500;
var circleOutDuration = circleInDuration;
var circleRadius = 40;
var clientColor = 'black';
var serverColor = 'cadetblue';
var initState = [];
...
function init() {
  ...
  d3.select('#viz>svg').selectAll('circle').data(initState).enter().append('circle').attr('cx', function (d) {
    return d.x * graphicWidth;
  }).attr('cy', function (d) {
    return d.y * graphicHeight;
  }).attr('r', function (d) {
    return d.r;
  });
}
...
function update0() {
  console.log(0);
  d3.select('#viz>svg').selectAll('circle') // .data(initState)
  .transition().duration(circleOutDuration).ease(d3.easeExp).attr('r', 0);
}
...
function update1() {
  ...
  d3.select('#viz>svg').selectAll('circle').data(state1).transition().duration(circleInDuration).ease(d3.easeExp).attr('cx', function (d) {
    return d.x * graphicWidth;
  }).attr('cy', function (d) {
    return d.y * graphicHeight;
  }).attr('r', function (d) {
...
function update2() {
  ...
  d3.select('#viz>svg').selectAll('circle').data(state2).transition().duration(circleInDuration).ease(d3.easeExp).attr('cx', function (d) {
    return d.x * graphicWidth;
  }).attr('cy', function (d) {
    return d.y * graphicHeight;
  }).attr('r', function (d) {
...
function update3() {
  ...
  d3.select('#viz>svg').selectAll('circle').data(state3).transition().duration(circleInDuration).ease(d3.easeExp).attr('cx', function (d) {
    return d.x * graphicWidth;
  }).attr('cy', function (d) {
    return d.y * graphicHeight;
  }).attr('r', function (d) {
...
//# sourceMappingURL=https://uw-cse442-wi20.github.io/FP-understanding-paxos/src.6635a23f.js.map