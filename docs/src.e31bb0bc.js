...
exports.BUTTON_DISABLED_OPACITY = exports.BUTTON_RADIUS = exports.BUTTON_HEIGHT_RATIO = exports.BUTTON_WIDTH_RATIO = exports.BUTTON_CAPTION_PADDING_PX = exports.BUTTON_FONT_SIZE = exports.CAPTION_SUBTITLE_PADDING_PX = exports.CAPTION_BASELINE_LINES = exports.CAPTION_LEFT_SCREEN_WIDTH_RATIO = exports.SUBTITLE_FONT_SIZE = exports.TITLE_FONT_SIZE = exports.PAGE_AUTHORS_FONT_SIZE_1 = exports.PAGE_AUTHORS_FONT_SIZE_0 = exports.PAGE_TITLE_FONT_SIZE_1 = exports.PAGE_TITLE_FONT_SIZE_0 = exports.MESSAGE_LATENCY_SMALL_MS = exports.MESSAGE_LATENCY_LARGE_MS = exports.MESSAGE_DURATION_FAST_MS = exports.MESSAGE_DURATION_SLOW_MS = exports.MESSAGE_RADIUS_PX = exports.CIRCLE_DISABLED_OPACITY = exports.CIRCLE_VALUE_TRANSITION_MS = exports.CIRCLE_VALUE_FONT_SIZE = exports.CIRCLE_GLOW_OPACITY = exports.CIRCLE_GLOW_PX = exports.CIRCLE_LABEL_PADDING_PX = exports.STATE_TRANSITION_MS = exports.CIRCLE_FILL_RATIO = exports.GRAPHIC_TO_SCREEN_HEIGHT_RATIO = exports.GRAPHIC_TO_SCREEN_WIDTH_RATIO = void 0;
var GRAPHIC_TO_SCREEN_WIDTH_RATIO = 0.7;
exports.GRAPHIC_TO_SCREEN_WIDTH_RATIO = GRAPHIC_TO_SCREEN_WIDTH_RATIO;
var GRAPHIC_TO_SCREEN_HEIGHT_RATIO = 1;
exports.GRAPHIC_TO_SCREEN_HEIGHT_RATIO = GRAPHIC_TO_SCREEN_HEIGHT_RATIO;
var CIRCLE_FILL_RATIO = 0.8;
exports.CIRCLE_FILL_RATIO = CIRCLE_FILL_RATIO;
var STATE_TRANSITION_MS = 200;
exports.STATE_TRANSITION_MS = STATE_TRANSITION_MS;
var CIRCLE_LABEL_PADDING_PX = 20;
exports.CIRCLE_LABEL_PADDING_PX = CIRCLE_LABEL_PADDING_PX;
var CIRCLE_GLOW_PX = 10;
exports.CIRCLE_GLOW_PX = CIRCLE_GLOW_PX;
var CIRCLE_GLOW_OPACITY = 0.6;
exports.CIRCLE_GLOW_OPACITY = CIRCLE_GLOW_OPACITY;
var CIRCLE_VALUE_FONT_SIZE = 16;
exports.CIRCLE_VALUE_FONT_SIZE = CIRCLE_VALUE_FONT_SIZE;
var CIRCLE_VALUE_TRANSITION_MS = 100;
exports.CIRCLE_VALUE_TRANSITION_MS = CIRCLE_VALUE_TRANSITION_MS;
var CIRCLE_DISABLED_OPACITY = 0.2;
exports.CIRCLE_DISABLED_OPACITY = CIRCLE_DISABLED_OPACITY;
var MESSAGE_RADIUS_PX = 20;
exports.MESSAGE_RADIUS_PX = MESSAGE_RADIUS_PX;
var MESSAGE_DURATION_SLOW_MS = 1000;
exports.MESSAGE_DURATION_SLOW_MS = MESSAGE_DURATION_SLOW_MS;
var MESSAGE_DURATION_FAST_MS = 500;
exports.MESSAGE_DURATION_FAST_MS = MESSAGE_DURATION_FAST_MS;
var MESSAGE_LATENCY_LARGE_MS = 4000;
exports.MESSAGE_LATENCY_LARGE_MS = MESSAGE_LATENCY_LARGE_MS;
var MESSAGE_LATENCY_SMALL_MS = 1000;
exports.MESSAGE_LATENCY_SMALL_MS = MESSAGE_LATENCY_SMALL_MS;
var PAGE_TITLE_FONT_SIZE_0 = 36;
exports.PAGE_TITLE_FONT_SIZE_0 = PAGE_TITLE_FONT_SIZE_0;
var PAGE_TITLE_FONT_SIZE_1 = 14;
exports.PAGE_TITLE_FONT_SIZE_1 = PAGE_TITLE_FONT_SIZE_1;
var PAGE_AUTHORS_FONT_SIZE_0 = 12;
exports.PAGE_AUTHORS_FONT_SIZE_0 = PAGE_AUTHORS_FONT_SIZE_0;
var PAGE_AUTHORS_FONT_SIZE_1 = 0;
exports.PAGE_AUTHORS_FONT_SIZE_1 = PAGE_AUTHORS_FONT_SIZE_1;
var TITLE_FONT_SIZE = 32;
exports.TITLE_FONT_SIZE = TITLE_FONT_SIZE;
var SUBTITLE_FONT_SIZE = 18;
exports.SUBTITLE_FONT_SIZE = SUBTITLE_FONT_SIZE;
var CAPTION_LEFT_SCREEN_WIDTH_RATIO = 0;
exports.CAPTION_LEFT_SCREEN_WIDTH_RATIO = CAPTION_LEFT_SCREEN_WIDTH_RATIO;
var CAPTION_BASELINE_LINES = 6;
exports.CAPTION_BASELINE_LINES = CAPTION_BASELINE_LINES;
var CAPTION_SUBTITLE_PADDING_PX = 10;
exports.CAPTION_SUBTITLE_PADDING_PX = CAPTION_SUBTITLE_PADDING_PX;
var BUTTON_FONT_SIZE = 18;
exports.BUTTON_FONT_SIZE = BUTTON_FONT_SIZE;
var BUTTON_CAPTION_PADDING_PX = 10;
exports.BUTTON_CAPTION_PADDING_PX = BUTTON_CAPTION_PADDING_PX;
var BUTTON_WIDTH_RATIO = 0.08;
exports.BUTTON_WIDTH_RATIO = BUTTON_WIDTH_RATIO;
var BUTTON_HEIGHT_RATIO = 0.05;
exports.BUTTON_HEIGHT_RATIO = BUTTON_HEIGHT_RATIO;
var BUTTON_RADIUS = 5;
exports.BUTTON_RADIUS = BUTTON_RADIUS;
var BUTTON_DISABLED_OPACITY = 0.2;
exports.BUTTON_DISABLED_OPACITY = BUTTON_DISABLED_OPACITY;
...
exports.setGraphicSize = setGraphicSize;
exports.drawPageTitle = drawPageTitle;
exports.drawCircles = drawCircles;
exports.drawCircleValues = drawCircleValues;
exports.updateCircleValue = updateCircleValue;
exports.drawCircleLabels = drawCircleLabels;
...
exports.drawGlow = drawGlow;
exports.drawReset = drawReset;
exports.drawPrev = drawPrev;
exports.drawNext = drawNext;
exports.reset = reset;
...
var width, height;
var stateNumber, state, messages, captions;

function setState(currentStateNumber, currentState, currentMessages, currentCaptions) {
...
function setGraphicSize(graphicWidth, graphicHeight) {
  width = graphicWidth;
  height = graphicHeight;
}

function drawPageTitle(stateNumber) {
  console.log('Draw::drawPageTitle', stateNumber);
  d3.select('#title').transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).style('left', function () {
    if (stateNumber == 0) {
  ...
  d3.select('#title h1').style('font-size', (stateNumber == 0 ? CONSTANTS.PAGE_TITLE_FONT_SIZE_0 : CONSTANTS.PAGE_TITLE_FONT_SIZE_1) + 'pt');
  d3.select('#title h4').style('font-size', (stateNumber == 0 ? CONSTANTS.PAGE_AUTHORS_FONT_SIZE_0 : CONSTANTS.PAGE_AUTHORS_FONT_SIZE_1) + 'pt');
}

function drawCircles(stateNumber) {
  console.log('Draw::drawCircles', stateNumber); // create circles if necessary

  d3.select('#paxos svg').selectAll('.machine').data(state).enter().append('circle').classed('machine', true).attr('id', function (d, i) {
    return 'server' + i;
  }); // update circle positions

  return d3.select('#paxos svg').selectAll('.machine').attr('class', function (d) {
    return d.class + ' machine';
  }).transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('cx', function (d) {
    return d.x * width + 'px';
  }).attr('cy', function (d) {
    return d.y * height + 'px';
  }).attr('r', function (d) {
    return d.r;
    ...
    return d3.scaleLinear().domain([0, 1]).range(['white', d.fill])(CONSTANTS.CIRCLE_FILL_RATIO);
  });
}

function drawCircleValues(stateNumber) {
  var machines = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  console.log('Draw::drawCircleValues', stateNumber, machines); // create if necessary

  d3.select('#paxos svg').selectAll('.value').data(state).enter().append('text').classed('value', true).attr('text-anchor', 'middle').attr('dominant-baseline', 'middle').style('font-size', CONSTANTS.CIRCLE_VALUE_FONT_SIZE).attr('id', function (d, i) {
    return 'value' + i;
  }).attr('x', function (d, i) {
    return d.x * width;
  }).attr('y', function (d, i) {
    ...
    if (d.showvalue) {
      if (machines == null) {// put logic here ?
      } else {
        switch (d.class) {
  ...
  d3.select('#paxos svg').selectAll('.value').transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('opacity', function (d) {
    return d.showvalue ? 1 : 0;
  });
}

function updateCircleValue(stateNumber, machineNumber, value) {
  var consensus = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  console.log('Draw::updateCircleValue', stateNumber, machineNumber, value, consensus); // update value

  d3.select('#value' + machineNumber).text(value); // .classed('consensus', consensus)
  // .style('fill', consensus ? 'black': 'red')
}

function drawCircleLabels(stateNumber) {
  console.log('Draw::drawCircleLabels', stateNumber); // create circles if necessary

  d3.select('#paxos svg').selectAll('.label').data(state).enter().append('text').classed('label', true).attr('text-anchor', 'middle'); // .attr('dominant-baseline', 'middle');
  // update label positions

  d3.select('#paxos svg').selectAll('.label').transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('x', function (d) {
    return d.x * width + 'px';
  }).attr('y', function (d) {
    return d.y * height - d.r - CONSTANTS.CIRCLE_LABEL_PADDING_PX + 'px';
  }).attr('opacity', function (d) {
    return d.opacity;
  }).text(function (d) {
    return d.label;
...
function drawTitle(stateNumber) {
  console.log('Draw::drawTitle', stateNumber);
  d3.select('#caption h1').data(captions).text(function (d) {
    return d.title;
  }).transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('opacity', function (d) {
    return d.opacity;
  });
}

function drawSubtitle(stateNumber) {
  console.log('Draw::drawSubtitle', stateNumber);
  d3.select('#caption').select('p').data(captions).html(function (d) {
    return d.subtitle;
  }).transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('opacity', function (d) {
    return d.opacity;
  });
...
function drawMessage(stateNumber, sender, sendee, duration, clientNum) {
...
function drawMessages(stateNumber) {
  console.log('Draw::drawMessages', stateNumber); // check if we've hardcoded messages for this state
  ...
  var _loop = function _loop(i) {
    ...
    updateCircleValue(stateNumber, message.sender, message.message, false); // send messages on click
...
function drawGlow(stateNumber, sender) {
  console.log('Draw::drawGlow', stateNumber, sender);
  d3.select('#paxos svg').append('circle').classed('glow', true).attr('cx', state[sender].x * width).attr('cy', state[sender].y * height).attr('r', state[sender].r).attr('opacity', 0).moveToBack().transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('r', state[sender].r + CONSTANTS.CIRCLE_GLOW_PX).attr('opacity', CONSTANTS.CIRCLE_GLOW_OPACITY);
}

function drawReset() {
  console.log('Draw::drawReset');
  d3.select('#paxos svg').selectAll('rect.reset').data(captions).enter().append('rect').classed('reset', true).classed('button', true).attr('x', (width - CONSTANTS.BUTTON_WIDTH_RATIO * width) / 2).attr('y', height - CONSTANTS.CAPTION_SUBTITLE_PADDING_PX - CONSTANTS.BUTTON_HEIGHT_RATIO * height).attr('width', CONSTANTS.BUTTON_WIDTH_RATIO * width).attr('height', CONSTANTS.BUTTON_HEIGHT_RATIO * height).attr('rx', CONSTANTS.BUTTON_RADIUS).attr('opacity', CONSTANTS.BUTTON_DISABLED_OPACITY);
  d3.select('#paxos svg').selectAll('text.reset').data(captions).enter().append('text').text('reset').classed('reset', true).classed('button', true).attr('x', width / 2).attr('y', height - CONSTANTS.CAPTION_SUBTITLE_PADDING_PX - CONSTANTS.BUTTON_HEIGHT_RATIO * height / 2).attr('text-anchor', 'middle').attr('dominant-baseline', 'middle').style('font-size', CONSTANTS.BUTTON_FONT_SIZE).attr('opacity', CONSTANTS.BUTTON_DISABLED_OPACITY);
  d3.select('#paxos svg').selectAll('.reset').transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('opacity', function (d) {
    return d.resetenabled ? 1 : CONSTANTS.BUTTON_DISABLED_OPACITY;
  });
}

function drawPrev() {
  console.log('Draw::drawPrev');
  d3.select('#paxos svg').selectAll('rect.prev').data(captions).enter().append('rect').classed('prev', true).classed('button', true).attr('x', (width - CONSTANTS.BUTTON_WIDTH_RATIO * width) / 2 - CONSTANTS.BUTTON_WIDTH_RATIO * width - CONSTANTS.BUTTON_CAPTION_PADDING_PX).attr('y', height - CONSTANTS.CAPTION_SUBTITLE_PADDING_PX - CONSTANTS.BUTTON_HEIGHT_RATIO * height).attr('width', CONSTANTS.BUTTON_WIDTH_RATIO * width).attr('height', CONSTANTS.BUTTON_HEIGHT_RATIO * height).attr('rx', CONSTANTS.BUTTON_RADIUS).attr('opacity', CONSTANTS.BUTTON_DISABLED_OPACITY);
  d3.select('#paxos svg').selectAll('text.prev').data(captions).enter().append('text').text('prev').classed('prev', true).classed('button', true).attr('x', width / 2 - CONSTANTS.BUTTON_WIDTH_RATIO * width - CONSTANTS.BUTTON_CAPTION_PADDING_PX).attr('y', height - CONSTANTS.CAPTION_SUBTITLE_PADDING_PX - CONSTANTS.BUTTON_HEIGHT_RATIO * height / 2).attr('text-anchor', 'middle').attr('dominant-baseline', 'middle').style('font-size', CONSTANTS.BUTTON_FONT_SIZE).attr('opacity', CONSTANTS.BUTTON_DISABLED_OPACITY);
  d3.select('#paxos svg').selectAll('.prev').transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('opacity', function (d) {
    return d.prevenabled ? 1 : CONSTANTS.BUTTON_DISABLED_OPACITY;
  });
}

function drawNext() {
  console.log('Draw::drawNext');
  d3.select('#paxos svg').selectAll('rect.next').data(captions).enter().append('rect').classed('next', true).classed('button', true).attr('x', (width - CONSTANTS.BUTTON_WIDTH_RATIO * width) / 2 + CONSTANTS.BUTTON_WIDTH_RATIO * width + CONSTANTS.BUTTON_CAPTION_PADDING_PX).attr('y', height - CONSTANTS.CAPTION_SUBTITLE_PADDING_PX - CONSTANTS.BUTTON_HEIGHT_RATIO * height).attr('width', CONSTANTS.BUTTON_WIDTH_RATIO * width).attr('height', CONSTANTS.BUTTON_HEIGHT_RATIO * height).attr('rx', CONSTANTS.BUTTON_RADIUS).attr('opacity', CONSTANTS.BUTTON_DISABLED_OPACITY);
  d3.select('#paxos svg').selectAll('text.next').data(captions).enter().append('text').text('next').classed('next', true).classed('button', true).attr('x', width / 2 + CONSTANTS.BUTTON_WIDTH_RATIO * width + CONSTANTS.BUTTON_CAPTION_PADDING_PX).attr('y', height - CONSTANTS.CAPTION_SUBTITLE_PADDING_PX - CONSTANTS.BUTTON_HEIGHT_RATIO * height / 2).attr('text-anchor', 'middle').attr('dominant-baseline', 'middle').style('font-size', CONSTANTS.BUTTON_FONT_SIZE).attr('opacity', CONSTANTS.BUTTON_DISABLED_OPACITY);
  d3.select('#paxos svg').selectAll('.next').transition().duration(CONSTANTS.STATE_TRANSITION_MS).ease(d3.easeQuad).attr('opacity', function (d) {
    return d.nextenabled ? 1 : CONSTANTS.BUTTON_DISABLED_OPACITY;
  });
}

function reset() {
  // reset listeners
  d3.select('#paxos svg').selectAll('.machine').on('click', null); // reset messages

  d3.select('#paxos svg').selectAll('.message').remove(); // reset glow

  d3.select('#paxos svg').selectAll('.glow').remove(); // reset values
...
},{"d3":"../node_modules/d3/index.js","./constants.js":"constants.js"}],"paxos.js":[function(require,module,exports) {
"use strict";
...
var PaxosMachine = /*#__PURE__*/function () {
  // role is one of ['client'|'proposer'|'acceptor'|'learner'|]
  function PaxosMachine(role, cluster) {
    _classCallCheck(this, PaxosMachine);
  ...
  _createClass(PaxosMachine, [{
    ...
    value: function handle(message) {
      ...
      console.log('PaxosMachine::handle', message, this); // reset listener
              ...
              case 'client request':
                {
                  if (this.proposerValue == undefined) {
                    ...
                    this.proposerAcceptVoters = []; // TODO: send prepare requests to all acceptors (p1a)

                    var p1a = {
                      type: 'prepare request',
                      proposalNumber: this.proposerProposalNumber,
                      sender: this,
              ...
              case 'prepare response':
                {
                  ...
                  if (message.status == 'fail') {
                    ...
                    this.proposerProposalVoters = [];
                    this.proposerAcceptVoters = []; // TODO: resend p1a
                    ...
                    Draw.updateCircleValue(this.cluster.stateNum, this.machineIndex, this.proposerProposalNumber + ', ' + this.proposerValue + ', ' + this.proposerProposalVoters.length + '/' + this.cluster.acceptors.length + ', ' + this.proposerAcceptVoters.length + '/' + this.cluster.acceptors.length, false);
                    this.cluster.send(_p1a, this, this.cluster.acceptors);
                    ...
                    if (!(message.sender in this.proposerProposalVoters)) {
                      this.proposerProposalVoters.push(message.sender); // majority consensus
              ...
              case 'accept response':
                {
                  ...
                  if (message.status == 'fail') {
                    ...
                    Draw.updateCircleValue(this.cluster.stateNum, this.machineIndex, this.proposerProposalNumber + ', ' + this.proposerValue + ', ' + this.proposerProposalVoters.length + '/' + this.cluster.acceptors.length + ', ' + this.proposerAcceptVoters.length + '/' + this.cluster.acceptors.length, false);
                    this.cluster.send(_p1a2, this, this.cluster.acceptors);
                  } else if (message.status == 'success') {
                    if (!(message.sender in this.proposerAcceptVoters)) {
                      this.proposerAcceptVoters.push(message.sender); // majority consensus
              ...
              case 'prepare request':
                {
                  if (this.acceptorProposalNumber < message.proposalNumber) {
                    this.acceptorProposalNumber = message.proposalNumber; // send success prepare response with current value and acceptNumber

                    var p1b = {
                      type: 'prepare response',
                      status: 'success',
                      proposalNumber: this.acceptorAcceptNumber,
                      value: this.acceptorValue,
                      client: message.client
                    };
                    ...
                    this.cluster.updateListeners(message); // send fail prepare response
              ...
              case 'accept request':
                {
                  if (this.acceptorProposalNumber <= message.proposalNumber) {
                    ...
                    this.acceptorValue = message.value; // send succes accept response
                    ...
                    this.cluster.updateListeners(message); // // send fail accept response
...
var PaxosCluster = /*#__PURE__*/function () {
  function PaxosCluster(stateNum, state) {
    var step = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var kill = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;

    _classCallCheck(this, PaxosCluster);
  ...
  _createClass(PaxosCluster, [{
    ...
    value: function reset() {
      ...
      this.acceptors = [];
      this.learners = [];
      this.machines = []; // this.machines maintains same order as state
    ...
    key: "send",
    value: function send(message, sender, sendees) {
      var _this = this;

      console.log('PaxosCluster::send', message, sender, sendees); // for future validation

      message.sequenceNum = this.sequenceNum;
      sender = this.machines.indexOf(sender);
      sendees = sendees.map(function (s) {
        return _this.machines.indexOf(s);
      });
      ...
      var _loop = function _loop(i) {
        ...
        if (_this.stateNum == 23) {
          Draw.drawMessage(_this.stateNum, sender, sendees[i], CONSTANTS.MESSAGE_DURATION_SLOW_MS, _this.clients.indexOf(message.client) + 1, function () {
            // validate
          ...
          Draw.drawMessage(_this.stateNum, sender, sendees[i], CONSTANTS.MESSAGE_DURATION_FAST_MS, _this.clients.indexOf(message.client) + 1, function () {
            // validate
            if (message.sequenceNum == that.sequenceNum) {
              that.machines[sendees[i]].handle(message);
            }
    ...
    key: "updateListeners",
    value: function updateListeners(message) {
      var _this2 = this;
      ...
      console.log('PaxosCluster::updateListeners', this.sendMap); // reset glow

      d3.select('#paxos svg').selectAll('.glow').remove(); // update listeners

      var that = this;

      var _loop2 = function _loop2(key) {
        Draw.drawGlow(_this2.stateNum, key);
        d3.select('#paxos svg').selectAll('#server' + key + ',#value' + key).on('click', function () {
          d3.select('#paxos svg').selectAll('#server' + key + ', #value' + key).on('click', null);
          var v = that.sendMap[key];
      ...
      for (var key in this.sendMap) {
        _loop2(key);
      }
    }
  }, {
    key: "killMachine",
    value: function killMachine(machineIdx) {
      ...
      d3.selectAll('#server' + machineIdx + ',' + '#value' + machineIdx).attr('opacity', CONSTANTS.CIRCLE_DISABLED_OPACITY).on('click', null);
...
},{"d3":"../node_modules/d3/index.js","./constants.js":"constants.js","./draw.js":"draw.js"}],"states.js":[function(require,module,exports) {
"use strict";
...
var _paxos = _interopRequireDefault(require("./paxos.js"));
...
var States = /*#__PURE__*/function () {
  ...
  _createClass(States, null, [{
    key: "import",
    value: function _import(data, out) {
      States[out] = [];
      return d3.tsv(data).then(function (d) {
        for (var i in d) {
          var row = d[i];
          ...
          for (var _i = 0, _Object$entries = Object.entries(row); _i < _Object$entries.length; _i++) {
            ...
            switch (keyParts[1]) {
              ...
              case 'array':
                entry[keyParts[0]] = value.substring(1, value.length - 1).split(' ').map(function (d) {
                  return +d;
                });
                break;
            }
    ...
    key: "update",
    value: function update(stateNumber, graphicWidth, graphicHeight) {
      ...
      Draw.drawCircles(stateNumber).end().then(function () {
        switch (stateNumber) {
          case 24:
          case 23:
            States.cluster = new _paxos.default(stateNumber, States.states[stateNumber], false, true);
            Draw.drawCircleValues(stateNumber, States.cluster.machines);
            States.cluster.clients.forEach(function (client, i) {
            ...
            States.cluster.clients.forEach(function (client) {
          ...
          case 21:
            {
              States.cluster = new _paxos.default(stateNumber, States.states[stateNumber], true, false);
              Draw.drawCircleValues(stateNumber, States.cluster.machines);
              States.cluster.clients.forEach(function (client, i) {
                Draw.updateCircleValue(stateNumber, client.machineIndex, States.messages[stateNumber][i].message, false);
              });
          ...
          case 6:
            {
              Draw.drawCircleValues(stateNumber, null); // Draw.drawMessages(stateNumber);

              States.setup6();
              States.messages[stateNumber].forEach(function (message) {
                if (message.sender != 5) {
    ...
    key: "setupListeners",
    value: function setupListeners(stateNumber) {
      console.log('State::setupListeners', stateNumber); // client listener

      States.cluster.clients.forEach(function (client, i) {
        d3.select('#paxos svg').selectAll('#server' + client.machineIndex + ',#value' + client.machineIndex).on('click', function () {
          var clientRequest = {
            type: 'client request',
            value: States.messages[stateNumber][i].message,
            client: client
          };
      ...
      if (States.cluster.kill) {
        States.cluster.proposers.forEach(function (server) {
          d3.select('#paxos svg').selectAll('#server' + server.machineIndex + ',#value' + server.machineIndex).on('click', function () {
            States.cluster.killMachine(server.machineIndex);
          });
        });
        States.cluster.acceptors.forEach(function (server) {
          d3.select('#paxos svg').selectAll('#server' + server.machineIndex + ',#value' + server.machineIndex).on('click', function () {
            States.cluster.killMachine(server.machineIndex);
          });
        });
        States.cluster.learners.forEach(function (server) {
          d3.select('#paxos svg').selectAll('#server' + server.machineIndex + ',#value' + server.machineIndex).on('click', function () {
            States.cluster.killMachine(server.machineIndex);
          });
        });
    ...
    key: "setupWalkthrough",
    value: function setupWalkthrough(stateNumber) {
    ...
    key: "setup6",
    value: function setup6() {
      console.log('Sates::setup6');
      var messages = States.messages[6];
      var broadcast;
      var fixed = false;
      ...
      var _loop = function _loop(i) {
        ...
        Draw.updateCircleValue(States.stateNumber, message.sender, message.message, false); // send messages on click
        ...
        d3.select('#paxos svg').selectAll('#server' + message.sender + ',#value' + message.sender).on('click', function () {
          var _loop2 = function _loop2(j) {
            Draw.drawMessage(States.stateNumber, message.sender, message.sendee[j], CONSTANTS.MESSAGE_DURATION_FAST_MS, message.sender + 1, function () {
              ...
              d3.select('#paxos svg').selectAll('#server' + message.sendee[j] + ',#value' + message.sendee[j]).on('click', function () {
...
},{"d3":"../node_modules/d3/index.js","./draw.js":"draw.js","./constants.js":"constants.js","./paxos.js":"paxos.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var statesData = require('../data/states.txt');

var captionsData = require('../data/captions.txt');

var messageData = require('../data/messages.txt');
...
function init() {
  ...
  _states.default.import(statesData, 'states').then(function () {
    return _states.default.import(captionsData, 'captions').then(function () {
      return _states.default.import(messageData, 'messages');
    }).then(function () {
      return start();
    });
  });
...
function resize() {
  ...
  if (_states.default.states != undefined) {
    update();
  }
}
...
function setupStateListeners() {
  ...
  //   update();
  // });
  d3.select('#paxos svg').selectAll('.prev').on('click', function (d) {
    if (d.prevenabled) {
      currentState--;
      update();
    }
  ...
  d3.select('#paxos svg').selectAll('.next').on('click', function (d) {
    if (d.nextenabled) {
      currentState++;
      update();
    }
  ...
  d3.select('#paxos svg').selectAll('.reset').on('click', function (d) {
    if (d.resetenabled) {
      switch (currentState) {
        case 21:
          {
            _states.default.cluster.reset();
...
},{"d3":"../node_modules/d3/index.js","../data/states.txt":"../data/states.txt","../data/captions.txt":"../data/captions.txt","../data/messages.txt":"../data/messages.txt","./constants.js":"constants.js","./states.js":"states.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
